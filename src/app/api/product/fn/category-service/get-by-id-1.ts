...
export function getById1(http: HttpClient, rootUrl: string, params: GetById1$Params, context?: HttpContext): Observable<StrictHttpResponse<CategoryResponseDto>> {
...
getById1.PATH = '/api/v1/categories/{id}';
