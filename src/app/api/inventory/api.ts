...
import { InventoryApiConfiguration } from './inventory-api-configuration';
...
export class Api {
  constructor(
    private config: InventoryApiConfiguration,
   ...
   * will fallback to `InventoryApiConfiguration.rootUrl`.
   */
  get rootUrl(): string {
